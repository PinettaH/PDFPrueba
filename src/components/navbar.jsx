...
<header class="lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2 bg-cyan-700">
...
<div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
    ...
    <ul class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
        ...
        <li><a class="text-black lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-800 lg:mb-0 mb-2" href="#">cerrar sesion</a></li>
    </ul>
    </nav>
